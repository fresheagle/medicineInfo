...
@Component
@Order(7)
public class MissChineseMedicalOperateService extends AbstractOperateService<Miss_medicalWithBLOBs, MissMedicalDTO> {

    @Autowired
    private MissMedicalService medicalService;

    private static Logger logger = LoggerFactory.getLogger(MissChineseMedicalOperateService.class);
    
    @Override
    public String getCurrentMenuType() {
        return "missChineseMedical";
    }
